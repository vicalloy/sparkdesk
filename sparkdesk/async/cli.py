...
def _chat(app_id: str, api_secret: str, api_key: str, api_version: str):
    asyncio.run(_async_chat(app_id, api_secret, api_key, api_version))


async def _async_chat(app_id: str, api_secret: str, api_key: str, api_version: str):
    ...
    while True:
        ...
        async for response in chat.ask(question):
            for content in [
